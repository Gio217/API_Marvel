...
import 'package:apimarvel/Models/Characters.dart' as ch;
import 'package:apimarvel/Screens/ComicsController.dart';
              ...
              child: Container(
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      ch.Characters perso = snapshot.data![index] as ch.Characters;
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Center(
                                    child: Text(
                                  perso.name!,
                                  style: TextStyle(fontSize: _tela!.width * .08, color: perso.clicked ? Colors.white : Colors.black),
                                )),
                              ),
                              Expanded(
                                  child: Container(
                              ...
                              Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      ...
                                      style: TextStyle(color: perso.clicked ? Colors.white : Colors.black, fontSize: _tela!.width * .08),
                                    ),
                                  )),
                            ],
                          ),
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Center(
                        child: Text(
                          "Comics listas",
                          style: TextStyle(color: Colors.white, fontSize: _tela!.width * .05),
                        ),
                      )),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Image.network("${comic.thumbnail!.path}.${comic.thumbnail!.extension}"),
                                  ),
